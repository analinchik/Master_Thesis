...
Filter out the modifications that occur is fewer than 5 projects. Dimensions before filtering `r dim(human_df)`
...
After filtering out all of the other modifications the final dimensions of the dataframe are `r dim(human_ptms)`
...
human_ptms_with_hl <- inner_join(human_ptms, half_lives_human, by = c("LeadProt" = "UniProtID")) 
