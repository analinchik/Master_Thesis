...
print('P-value cut-off (Good\'s Bayes adjustment)')
...
ggplot() +
  ...
  geom_density(data = human_ptms_hl_long, aes(x = mean_hl_hours, weight = counts_norm_abund_len, fill = 'Re-processed dataset'), alpha = 0.7, bw = 7) + 
